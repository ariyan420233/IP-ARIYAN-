...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "ariyan") || (event.body.toLowerCase() == "ariyan")) {
     return api.sendMessage("চলো বিয়ে করি baby", threadID);
   };
  
   if ((event.body.toLowerCase() == "ওই কিরে") || (event.body.toLowerCase() == "oi keray") ||(event.body.toLowerCase() == "bal") || (event.body.toLowerCase() == "বাল")) {
  ...
  if ((event.body.toLowerCase() == "IP-ARIYAN ") || (event.body.toLowerCase() == "IP-ARIYAN ") || (event.body.toLowerCase() == "@IP-ARIYAN ッ") || (event.body.toLowerCase() == "IP-ARIYAN ")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ IP-ARIYAN ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :-https://www.facebook.com/profile.php?id=61590366007318 তার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:IP-ARIYAN ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস IPআরিয়ান আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Ip ariyanッ❤️ তাকে সবাই IPআরিয়ান নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase(Ariyan) == "sala ami tor boss") || (event.body.toLowerCase(Jan) == "sala ") || (event.body.toLowerCase(কে তুই) == "cup sala ami Ip ariyan") || (event.body.toLowerCase() == "আরিয়ান")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@সি্ঁঙ্গা্ঁর্ঁ আ্ঁয়া্ঁত্ঁ ") || (event.body.toLowerCase() == "@一ꨄ ⵂ.ডি'জে Fɱ'z নিঝুৃম一ꕥ ᰔᩚ ᰔᩚ ᰔᩚ  ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার বস উল্লাস এর বউ এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "সাদিয়া") || (event.body.toLowerCase() == "নিঝুম")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস IPআরিয়ান এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "নিঝুম") || (event.body.toLowerCase() == "সাদিয়া")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস IP-ARIYAN এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "নিঝুম") || (event.body.toLowerCase() == "一ꨄ ⵂ.ডি'জে Fɱ'z নিঝুৃম一ꕥ ᰔᩚ ᰔᩚ ᰔᩚ")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবা না এটা আমার বস IPআরিয়ানের এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Ip Ariyan Tafeder ") || (event.body.toLowerCase() == "আরিয়ান")) {
     return api.sendMessage("🥰-Tom Chowdhury-🌺 আমার বস IP-ARIYAN ER  বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম সত্যিই নাকি 😹", threadID);
   };

   if ((event.body.toLowerCase() == "IP-ARIYAN") || (event.body.toLowerCase() == "IP-ARIYAN") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>Ip Ariyan ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "আয়াত") || (event.body.toLowerCase() == "ex")) {
     return api.sendMessage("️Kiss Randi Ka Name Le Ke Mood Khrab Kr Diya.🙄 Dubara Naam Mat Lena Iska", threadID);
   };

   if ((event.body.toLowerCase() == "🤬") || (event.body.toLowerCase() == "tor nanire Ummmmha")) {
     return api.sendMessage("️আমাকে চুম্মা দিলে। ৫০০টাকা দিমু..!🥱🌚", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ তাকিয়ে থেকে লাভ নাই যাও মুড়ি খাও 😹", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("জান ভালো বাসি বুঝো 🫶🫰", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("আই 🍋 টু জান 🫵", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami IP-ARIYAN ") || (event.body.toLowerCase() == "kire")) {
